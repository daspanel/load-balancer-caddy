...
## Quick Start
``` sh
    git clone https://github.com/daspanel/load-balancer-caddy
...
1. Run a container using this image and getting an interactive shell:
    <!-- language: lang-sh -->
        ...
        docker-compose run load-balancer-caddy /bin/sh
...
2. Execute scripts inside a running container:
    ...
    2. Excute the script:
        <!-- language: lang-sh -->
            ...
            docker-compose exec load-balancer-caddy /app/yourscript
