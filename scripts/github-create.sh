...
echo "Will create a new *$PRIVACYWORD* repo named load-balancer-caddy"
echo "on github.com in:"
echo "    user account: admindaspanel"
echo "    organization: daspanel"
echo "with this description:"
echo Docker image for Daspanel HTTP load balancer using Caddy.
echo ""
...
curl -u admindaspanel https://api.github.com/orgs/daspanel/repos -d \
    "{\"name\": \"load-balancer-caddy\", \"description\": \"Docker image for Daspanel HTTP load balancer using Caddy.\", \"private\": $PRIVATE_TF}"
